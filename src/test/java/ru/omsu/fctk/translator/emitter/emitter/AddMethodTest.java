...
public class AddMethodTest {
    ...
    public void givenNullMethod_whenAddMethod_thenThrowException() {
        emitter.addMethod(null);
    }

    @Test
    public void givenEmptyEmitter_whenAddMethod_thenMethodStored() {
    ...
    @Test
    public void givenMultipleMethods_whenAddMethod_thenAllStoredInOrder() {
        assertTrue("Methods list should be empty before adding", emitter.getMethods().isEmpty());
        emitter.addMethod(method_1);
    ...
    @Test(expected = IllegalArgumentException.class)
    public void givenDuplicateMethod_whenAddMethod_thenThrowException() {
        emitter.addMethod(method_1);
        emitter.addMethod(method_1);
    }

    @Test
    public void givenDifferentMethodObjectsWithSameContent_whenAddMethods_thenAllStored() {
